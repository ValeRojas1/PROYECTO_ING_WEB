...
$diccionario = [
    'es' => [
        ...
        'dash_add_asset' => 'Registrar Nuevo Bien',
        'dash_import_excel' => 'Importar desde Excel',
        'dash_make_movement' => 'Hacer Desplazamiento',
        'dash_gen_reports' => 'Generar Reportes',
        'dash_sys_info' => 'Información del Sistema',
        'dash_user' => 'Usuario:',
        'dash_role' => 'Rol:',
        'dash_login' => 'Login:',
        'dash_sys_ver' => 'Sistema de Control Patrimonial v1.0',
        // BIENES
    ...
    'en' => [
        ...
        'dash_add_asset' => 'Register New Asset',
        'dash_import_excel' => 'Import from Excel',
        'dash_make_movement' => 'Make Movement',
        'dash_gen_reports' => 'Generate Reports',
        'dash_sys_info' => 'System Information',
        'dash_user' => 'User:',
        'dash_role' => 'Role:',
        'dash_login' => 'Login:',
        'dash_sys_ver' => 'Asset Management System v1.0',
        // BIENES
